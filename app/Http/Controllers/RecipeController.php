...
class RecipeController extends Controller
{
    ...
    public function exportRecipe($id)
    {
        ...
        $csvExporter->build($departures, ["order_number" => "OT", "code" => "Código", "name" => "Nombre", "lot" => "Lote", "quantity" => "Tamaño de Lote", "quantity_real" => "Cantidad Real", "available_quantity"=>"Cantidad Disponible",  "expired_date" => "Fecha de Caducidad", "production_status"=>"Estatus de Producción", "quality_status"=>"Estatus de Calidad"])->download('inventario_' . str_replace("_", "/", $departures[0]->recipe->name) . '_' . date('d_m_Y') . '.csv');
    }
