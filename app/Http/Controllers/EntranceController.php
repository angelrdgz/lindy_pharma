            ...
            if ($departure->entrances != NULL) {
                foreach ($departure->entrances as $entrance) {
                    ...
                    $newdata =  array(
                        ...
                        'Cantidad Surtida (kg)' => number_format($this->reverse($departure->supply->measurement_buy, $departure->supply->measurement_use, $entrance->delivery_quantity) * 1000, 4),
                        'Cantidad Remanente (kg)' => number_format(($totals[$entrance->entrance_number] - $this->reverse($departure->supply->measurement_buy, $departure->supply->measurement_use, $entrance->delivery_quantity)) * 1000, 4),
                        'Tipo' => 'Producción',
