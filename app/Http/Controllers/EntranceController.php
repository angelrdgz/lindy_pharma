            ...
            if ($decrease->entrances != NULL) {
                foreach ($decrease->entrances as $entrance) {
                    ...
                    $newdata =  array(
                        ...
                        'entrance' => $entrance->entrance_number,
                        'Cantidad Entrada (kg)' => $entrance->entrance->quantity,
                        'Cantidad Surtida (kg)' => number_format(($entrance->delivery_quantity), 4),
                        'Cantidad Remanente (kg)' => number_format(($totals[$entrance->entrance_number] - ($entrance->delivery_quantity)), 4),
